...
def train(num_epoch, num_class, net, trainloader, validloader, optimizer, criterion, class_names, classifier=None,
    ...
    :param criterion: criterion by which to compute the loss
